...
{$ENDIF}
  ...
  QActnList, QMenus, QComCtrls, SvrLogDetailFrame, SvrLog, IniFiles, QTypes;
...
begin
  ...
  begin
    lvLog.Sort(Column.Index, sdAscending);
    Column.Tag := 1;
  end
  else
  begin
    lvLog.Sort(Column.Index, sdDescending);
    Column.Tag := 0;
  end;
end;
...
procedure TLogFrame.Load(Reg: TCustomIniFile; const Section: string);
var
  I: TLogColumn;
  SubSection: string;
begin
...
procedure TLogFrame.Save(Reg: TCustomIniFile; const Section: string);
var
  I: TLogColumn;
  SubSection: string;
begin
