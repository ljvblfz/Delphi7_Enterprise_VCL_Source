...
uses
  VarUtils, SysUtils, Math, SysConst, RTLConsts, TypInfo, Classes;
...
type
  ...
  public
    ...
    function Equals(const Right: TComplexData): Boolean; overload;
    function Equals(const AText: string): Boolean; overload;
    function Equals(const AReal, AImaginary: Double): Boolean; overload;
