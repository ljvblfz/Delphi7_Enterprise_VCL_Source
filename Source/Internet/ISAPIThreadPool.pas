...
uses SysUtils, WebBroker, ISAPIApp, ActiveX, ComObj;
...
begin
  ...
  //TODO: We shouldn't allow more than 64 threads here due to a limitation of WaitForMultipleObjects
...
begin
  ...
  // TODO: The timeout for WaitForMultipleObjects should be user configurable  
...
begin
  ...
  begin
    ...
    Result := PostQueuedCompletionStatus(FRequestQueue, Cardinal(ServerContext), 0, nil);
  end;
end;
