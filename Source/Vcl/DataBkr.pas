...
{$IFDEF MSWINDOWS}
uses Windows, Variants, ActiveX, Classes, Midas, Provider, SysUtils;
{$ENDIF}
{$IFDEF LINUX}
uses Libc, Variants, Classes, Midas, Provider, SysUtils;
{$ENDIF}
...
function TRemoteDataModule.GetProviderCount: integer;
begin
