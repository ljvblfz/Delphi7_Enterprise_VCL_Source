...
interface
uses
  Invoker, TypInfo, Classes, OPConvert, OPToSOAPDomConv, SOAPAttachIntf,
  WSDLIntf, Contnrs, InvokeRegistry;
...
uses SOAPConst, SysUtils, WebServExp,
InvConst, IntfInfo{$IFDEF MSWINDOWS}, ActiveX{$ENDIF};
