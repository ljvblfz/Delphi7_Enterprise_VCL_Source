...
function TIdFTPListItems.CheckListFormat(Data: string; const ADetails: Boolean = false): TIdFTPListFormat;
  ...
  begin
    ...
    (SData[2] in ['R','W','X','-']) and    {Do not Localize}
    (SData[3] in ['R','W','X','-']) and    {Do not Localize}
    (SData[4] in ['R','W','X','-']) and    {Do not Localize}
    (SData[5] in ['R','W','X','-']) and    {Do not Localize}
    (SData[6] in ['R','W','X','-']) and    {Do not Localize}
    (SData[7] in ['R','W','X','-']) and    {Do not Localize}
    (SData[8] in ['R','W','X','-']) and    {Do not Localize}
    (SData[9] in ['R','W','X','-']) and    {Do not Localize}
    (SData[10] in ['R','W','X','-']);    {Do not Localize}
  end;
