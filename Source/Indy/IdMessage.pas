...
// TODO: Override TIdMessageClient.SendMsg to provide socket, stream, and file versions like TIdMessageClient.ProcessMessage?
...
begin
  ...
  vIOHandler.WriteStream := AStream;
  vIOHandler.ReadStream := vVoidStream;
  ...
  try
    ...
    if (not AHeadersOnly) then vMsgClient.WriteLn('.');
    vMsgClient.CloseWriteBuffer;
  finally
    vIOHandler.WriteStream := nil;
    vIOHandler.ReadStream := nil;
    vVoidStream.Free;
