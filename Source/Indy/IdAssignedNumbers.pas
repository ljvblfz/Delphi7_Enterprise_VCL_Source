...
//These are multicast group IP addresses
  ...
  Id_IPMC_OSPFIGP_All_Routers = '224.0.0.5'; //OSPFIGP  OSPFIGP All Routers [RFC1583,JXM1]    {Do not Localize}
  Id_IPMC_OSPFIGP_Designated_Routers = '224.0.0.6'; //OSPFIGP  OSPFIGP Designated Routers      [RFC1583,JXM1]    {Do not Localize}
...
//224.0.0.12-224.0.0.255 Unassigned                            [JBP]
  Id_IPMC_DHCP_Server = '224.0.0.12';// DHCP Server / Relay Agent                     [RFC1884]
  Id_IPMC_DHCP_All_PIM_Routers = '224.0.0.13';// All PIM Routers                             [Farinacci]
  Id_IPMC_RSVP_ENCAPSULATION = '224.0.0.14';// RSVP-ENCAPSULATION                             [Braden]
  Id_IPMC_All_CDT_Routers = '224.0.0.15';// all-cbt-routers                             [Ballardie]
  Id_IPMC_designated_sbm = '224.0.0.16'; //designated-sbm				   [Baker]
  Id_IPMC_ll_sbms = '224.0.0.17';// all-sbms					   [Baker]
  Id_IPMC_VRRP = '224.0.0.18';// VRRP     [Hinden]
  Id_IPMC_IPAllL1ISs = '224.0.0.19';// IPAllL1ISs				      [Przygienda]
  Id_IPMC_IPAllL2ISs = '224.0.0.20';// IPAllL2ISs				      [Przygienda]
  Id_IPMC_IPAllIntermediate_Systems = '224.0.0.21';// IPAllIntermediate Systems	   [Przygienda]
  Id_IPMC_IGMP = '224.0.0.22';// IGMP 					 [Deering]
  Id_IPMC_GLOBECAST_ID = '224.0.0.23';// GLOBECAST-ID                                 [Scannell]
  //224.0.0.24 unassigned
  Id_IPMC_router_to_switch = '224.0.0.25';// router-to-switch                                   [Wu]
  //224.0.0.26 unassigned
  Id_IPMC_Al_MPP_Hello = '224.0.0.27';// Al MPP Hello                               [Martinicky]
  Id_IPMC_ETC_Control = '224.0.0.28';// ETC Control                               [Polishinski]
  Id_IPMC_GE_FANUC = '224.0.0.29';// GE-FANUC                                        [Wacey]
  Id_IPMC_INDIGO_VHDP = '224.0.0.30';// indigo-vhdp                                   [Caughie]
  Id_IPMC_shinbroadband = '224.0.0.31';// shinbroadband                       [Kittivatcharapong]
  Id_IPMC_digistar = '224.0.0.32';// digistar                                       [Kerkan]
  Id_IPMC_ff_system_Management = '224.0.0.33';// ff-system-management                          [Glanzer]
  Id_IPMC_pt2_discover = '224.0.0.34';// pt2-discover                             [Kammerlander]
  Id_IPMC_DXCLUSTER = '224.0.0.35';// DXCLUSTER                                     [Koopman]
  Id_IPMC_DTC_Announcement = '224.0.0.36';// DTCP Announcement                             [Cipiere]
  Id_IPMC_zeroconfaddr_Min = '224.0.0.37';// zeroconfaddr   (renew 12/02)       [Guttman]
  {Range}
  Id_IPMC_zeroconfaddr_Max = '224.0.0.68';
  //224.0.0.69-224.0.0.100 Reserved                             [IANA]
  Id_IPMC_Cisco_nhap = '224.0.0.101';// cisco-nhap                                     [Bakke]
  Id_IPMC_HSPP = '224.0.0.102';// HSRP                                          [Wilson]
  Id_IPMC_MDAP = '224.0.0.103'; //MDAP                                           [Deleu]
  //224.0.0.104-224.0.0.250 Unassigned                           [JBP]
  Id_IPMC_mDNS = '224.0.0.251';// mDNS                                        [Cheshire]
  ...
  Id_IPMC_lmsc_calren_1 = '224.0.1.27';// lmsc-calren-1                                    [Uang]
  Id_IPMC_lmsc_calren_2 = '224.0.1.28';//lmsc-calren-2                                    [Uang]
  Id_IPMC_lmsc_calren_3 = '224.0.1.29';// lmsc-calren-3                                    [Uang]
  Id_IPMC_lmsc_calren_4 = '224.0.1.30';// lmsc-calren-4                                    [Uang]
  Id_IPMC_ampr_info = '224.0.1.31';// ampr-info     [Janssen]
  Id_IPMC_mtrace = '224.0.1.32';// mtrace                                         [Casner]
  Id_IPMC_RSVP_encap_1 = '224.0.1.33';// RSVP-encap-1                                   [Braden]
  Id_IPMC_RSVP_encap_2 = '224.0.1.34';// RSVP-encap-2                                   [Braden]
  Id_IPMC_SVRLOC_DA = '224.0.1.35';// SVRLOC-DA                                    [Veizades]
  Id_IPMC_rln_server = '224.0.1.36'; //rln-server   [Kean]
  Id_IPMC_proshare_mc = '224.0.1.37';// proshare-mc                                     [Lewis]
  Id_IPMC_dantz = '224.0.1.38';//dantz                                           [Zulch]
  Id_IPMC_cisco_rp_announce = '224.0.1.39';// cisco-rp-announce                           [Farinacci]
  Id_IPMC_cisco_rp_discovery = '224.0.1.40';// cisco-rp-discovery                          [Farinacci]
  Id_IPMC_gatekeeper  = '224.0.1.41';// gatekeeper                                       [Toga]
  Id_IPMC_iberiagames  = '224.0.1.42';// iberiagames                                   [Marocho]
  Id_IPMC_nwn_discovery = '224.0.1.43';// nwn-discovery                                 [Zwemmer]
  Id_IPMC_nwn_adaptor  = '224.0.1.44';// nwn-adaptor                                   [Zwemmer]
  Id_IPMC_isma_1 = '224.0.1.45';// isma-1                                          [Dunne]
  Id_IPMC_isma_2 = '224.0.1.46';// isma-2                                          [Dunne]

  Id_IPMC_telerate = '224.0.1.47';// telerate					    [Peng]
  Id_IPMC_ciena = '224.0.1.48';// ciena                                         [Rodbell]
  Id_IPMC_dcap_servers = '224.0.1.49';// dcap-servers                                  [RFC2114]
  Id_IPMC_dcap_clients = '224.0.1.50';// dcap-clients					 [RFC2114]
  Id_IPMC_mcntp_directory = '224.0.1.51';// mcntp-directory				    [Rupp]
  Id_IPMC_mbone_vcr_directory = '224.0.1.52';// mbone-vcr-directory		               [Holfelder]
  Id_IPMC_heartbeat = '224.0.1.53';// heartbeat					 [Mamakos]
  Id_IPMC_sun_mc_grp = '224.0.1.54';// sun-mc-grp					 [DeMoney]
  Id_IPMC_extended_sys = '224.0.1.55';// extended-sys				           [Poole]
  Id_IPMC_pdrncs = '224.0.1.56'; //pdrncs				      [Wissenbach]
  Id_IPMC_tns_adv_multi	= '224.0.1.57'; //tns-adv-multi				   [Albin]
  Id_IPMC_vcals_dmu = '224.0.1.58'; //vcals-dmu					 [Shindoh]
  Id_IPMC_zuba = '224.0.1.59'; //zuba                                          [Jackson]
  Id_IPMC_hp_device_disc = '224.0.1.60'; //hp-device-disc                               [Albright]
  Id_IPMC_tms_production = '224.0.1.61'; //tms-production                                 [Gilani]
  Id_IPMC_sunscalar					 = '224.0.1.62'; //sunscalar					  [Gibson]
  Id_IPMC_mmtp_poll = '224.0.1.63'; //mmtp-poll                                    [Costales]
  Id_IPMC_compaq_peer					 = '224.0.1.64'; //compaq-peer					   [Volpe]
  Id_IPMC_iapp	= '224.0.1.65'; //iapp						   [Meier]
  Id_IPMC_multihasc_com	= '224.0.1.66'; //multihasc-com			       [Brockbank]
  Id_IPMC_serv_discovery = '224.0.1.67'; //serv-discovery				  [Honton]
  Id_IPMC_mdhcpdisover = '224.0.1.68'; //mdhcpdisover				         [RFC2730]
  Id_IPMC_MMP_bundle_discovery1 = '224.0.1.69'; //MMP-bundle-discovery1                          [Malkin]
  Id_IPMC_MMP_bundle_discovery2 = '224.0.1.70'; //MMP-bundle-discovery2                          [Malkin]
  Id_IPMC_XYPOINT = '224.0.1.71'; //XYPOINT DGPS Data Feed                          [Green]
  Id_IPMC_GilatSkySurfer = '224.0.1.72'; //GilatSkySurfer				     [Gal]
  Id_IPMC_SharesLive = '224.0.1.73'; //SharesLive                                     [Rowatt]
  Id_IPMC_NorthernData	= '224.0.1.74'; //NorthernData				          [Sheers]
  Id_IPMC_SIP = '224.0.1.75'; //SIP				             [Schulzrinne]
  Id_IPMC_IAPP2 = '224.0.1.76'; //IAPP                                          [Moelard]
  Id_IPMC_AGENTVIEW = '224.0.1.77'; //AGENTVIEW				            [Iyer]
  Id_IPMC_Tibco_1 = '224.0.1.78'; //Tibco Multicast1                                 [Shum]
  Id_IPMC_Tibco_2 = '224.0.1.79'; //Tibco Multicast2                                 [Shum]
  Id_IPMC_MSP = '224.0.1.80'; //MSP                                             [Caves]
  Id_IPMC_OTT = '224.0.1.81'; //OTT (One-way Trip Time)                      [Schwartz]
  Id_IPMC_TRACKTICKER = '224.0.1.82'; //TRACKTICKER                                    [Novick]
  Id_IPMC_dtn_mc = '224.0.1.83'; //dtn-mc                                         [Gaddie]
  Id_IPMC_jini_announcement = '224.0.1.84'; //jini-announcement			       [Scheifler]
  Id_IPMC_jini_request = '224.0.1.85'; //jini-request                                [Scheifler]
  Id_IPMC_sde_discovery = '224.0.1.86'; //sde-discovery				 [Aronson]
  Id_IPMC_DirecPC_SI = '224.0.1.87'; //DirecPC-SI					  [Dillon]
  Id_IPMC_B1RMonitor = '224.0.1.88'; //B1RMonitor                                    [Purkiss]
  Id_IPMC_3Com_AMP3 = '224.0.1.89'; //3Com-AMP3 dRMON                               [Banthia]
  Id_IPMC_imFtmSvc = '224.0.1.90'; //imFtmSvc                                       [Bhatti]
  Id_IPMC_NQDS4 = '224.0.1.91'; //NQDS4					   [Flynn]
  Id_IPMC_NQDS5 = '224.0.1.92'; //NQDS5					   [Flynn]
  Id_IPMC_NQDS6 = '224.0.1.93'; //NQDS6					   [Flynn]
  Id_IPMC_NLVL12 = '224.0.1.94'; //NLVL12					   [Flynn]
  Id_IPMC_NTDS1 = '224.0.1.95'; //NTDS1					   [Flynn]
  Id_IPMC_NTDS2 = '224.0.1.96'; //NTDS2					   [Flynn]
  Id_IPMC_NODSA = '224.0.1.97'; //NODSA					   [Flynn]
  Id_IPMC_NODSB = '224.0.1.98'; //NODSB					   [Flynn]
  Id_IPMC_NODSC = '224.0.1.99'; //NODSC					   [Flynn]
  Id_IPMC_NODSD = '224.0.1.100'; //NODSD					   [Flynn]
  Id_IPMC_NQDS4R = '224.0.1.101'; //NQDS4R					   [Flynn]
  Id_IPMC_NQDS5R = '224.0.1.102'; //NQDS5R					   [Flynn]
  Id_IPMC_NQDS6R = '224.0.1.103'; //NQDS6R					   [Flynn]
  Id_IPMC_NLVL12R = '224.0.1.104'; //NLVL12R					   [Flynn]
  Id_IPMC_NTDS1R = '224.0.1.105'; //NTDS1R					   [Flynn]
  Id_IPMC_NTDS2R = '224.0.1.106'; //NTDS2R					   [Flynn]
  Id_IPMC_NODSAR = '224.0.1.107'; //NODSAR					   [Flynn]
  Id_IPMC_NODSBR = '224.0.1.108'; //NODSBR					   [Flynn]
  Id_IPMC_NODSCR = '224.0.1.109'; //NODSCR					   [Flynn]
  Id_IPMC_NODSDR = '224.0.1.110'; //NODSDR					   [Flynn]
  Id_IPMC_MRM = '224.0.1.111'; //MRM						     [Wei]
  Id_IPMC_TVE_FILE = '224.0.1.112'; //TVE-FILE				     [Blackketter]
  Id_IPMC_TVE_ANNOUNCE = '224.0.1.113'; //TVE-ANNOUNCE			     [Blackketter]
  Id_IPMC_Mac = '224.0.1.114'; //Mac Srv Loc                                 [Woodcock]
  Id_IPMC_Simple = '224.0.1.115'; //Simple Multicast                           [Crowcroft]
  Id_IPMC_SpectraLinkGW	 = '224.0.1.116'; //SpectraLinkGW   	[Hamilton]				[Hamilton]
  Id_IPMC_dieboldmcast = '224.0.1.117'; //dieboldmcast			           [Marsh]
  Id_IPMC_Tivoli = '224.0.1.118'; //Tivoli Systems                               [Gabriel]
  Id_IPMC_pq_lic_mcast = '224.0.1.119'; //pq-lic-mcast				  [Sledge]
  Id_IPMC_HYPERFEED = '224.0.1.120'; //HYPERFEED				      [Kreutzjans]
  Id_IPMC_Pipesplatform = '224.0.1.121'; //Pipesplatform                                [Dissett]
  Id_IPMC_LiebDevMgmg_DM = '224.0.1.122'; //LiebDevMgmg-DM				  [Velten]
  Id_IPMC_TRIBALVOICE = '224.0.1.123'; //TRIBALVOICE				        [Thompson]
//  Id_IPMC_Unassigned = '//224.0.1.124'; //Unassigned (Retracted 1/29/01)
  Id_IPMC_PolyCom = '224.0.1.125'; //PolyCom Relay1                              [Coutiere]
  Id_IPMC_Infront = '224.0.1.126'; //Infront Multi1			        [Lindeman]
  Id_IPMC_XRX = '224.0.1.127'; //XRX DEVICE DISC				    [Wang]
  Id_IPMC_CNN = '224.0.1.128'; //CNN                                            [Lynch]
  Id_IPMC_PTP_primary = '224.0.1.129'; //PTP-primary					  [Eidson]
  Id_IPMC_PTP_alternate1 = '224.0.1.130'; //PTP-alternate1				  [Eidson]
  Id_IPMC_PTP_alternate2 = '224.0.1.131'; //PTP-alternate2				  [Eidson]
  Id_IPMC_PTP_alternate3 = '224.0.1.132'; //PTP-alternate3				  [Eidson]
  Id_IPMC_ProCast = '224.0.1.133'; //ProCast					  [Revzen]
  Id_IPMC_3Com = '224.0.1.134'; //3Com Discp					   [White]
  Id_IPMC_CS_Multicasting = '224.0.1.135'; //CS-Multicasting                               [Stanev]
  Id_IPMC_TS_MC_1 = '224.0.1.136'; //TS-MC-1				       [Sveistrup]
  Id_IPMC_Make = '224.0.1.137'; //Make Source					    [Daga]
  Id_IPMC_Teleborsa = '224.0.1.138'; //Teleborsa				       [Strazzera]
  Id_IPMC_SUMAConfig = '224.0.1.139'; //SUMAConfig					 [Wallach]
//  Id_IPMC_Unassigned = '224.0.1.140'; //Unassigned
  Id_IPMC_DHCP_SERVERS = '224.0.1.141'; //DHCP-SERVERS				    [Hall]
  Id_IPMC_CN = '224.0.1.142'; //CN Router-LL				[Armitage]
  Id_IPMC_EMWIN	= '224.0.1.143'; //EMWIN    	[Querubin] 					[Querubin]
  Id_IPMC_Alchemy = '224.0.1.144'; //Alchemy Cluster				[O'Rourke]
  Id_IPMC_Satcast_1 = '224.0.1.145'; //Satcast One					  [Nevell]
  Id_IPMC_Satcast_2 = '224.0.1.146'; //Satcast Two					  [Nevell]
  Id_IPMC_Satcast_3 = '224.0.1.147'; //Satcast Three				  [Nevell]
  Id_IPMC_Intline = '224.0.1.148'; //Intline				       [Sliwinski]
  Id_IPMC_8x8 = '224.0.1.149'; //8x8 Multicast				   [Roper]
//  Id_IPMC__Unassigned = '224.0.1.150'; //Unassigned                                       [JBP]
  Id_IPMC_Intline_1 = '224.0.1.151'; //Intline-1                                  [Sliwinski]
  Id_IPMC_Intline_2 = '224.0.1.152'; //Intline-2                                  [Sliwinski]
  Id_IPMC_Intline_3 = '224.0.1.153'; //Intline-3                                  [Sliwinski]
  Id_IPMC_Intline_4 = '224.0.1.154'; //Intline-4                                  [Sliwinski]
  Id_IPMC_Intline_5 = '224.0.1.155'; //Intline-5                                  [Sliwinski]
  Id_IPMC_Intline_6 = '224.0.1.156'; //Intline-6                                  [Sliwinski]
  Id_IPMC_Intline_7 = '224.0.1.157'; //Intline-7                                  [Sliwinski]
  Id_IPMC_Intline_8 = '224.0.1.158'; //Intline-8                                  [Sliwinski]
  Id_IPMC_Intline_9 = '224.0.1.159'; //Intline-9                                  [Sliwinski]
  Id_IPMC_Intline_10 = '224.0.1.160'; //Intline-10                                 [Sliwinski]
  Id_IPMC_Intline_11 = '224.0.1.161'; //Intline-11                                 [Sliwinski]
  Id_IPMC_Intline_12 = '224.0.1.162'; //Intline-12                                 [Sliwinski]
  Id_IPMC_Intline_13 = '224.0.1.163'; //Intline-13                                 [Sliwinski]
  Id_IPMC_Intline_14 = '224.0.1.164'; //Intline-14                                 [Sliwinski]
  Id_IPMC_Intline_15 = '224.0.1.165'; //Intline-15                                 [Sliwinski]
  Id_IPMC_marratech_cc = '224.0.1.166'; //marratech-cc                                  [Parnes]
  Id_IPMC_EMS_InterDev = '224.0.1.167'; //EMS-InterDev                                    [Lyda]
  Id_IPMC_itb301 = '224.0.1.168'; //itb301                                      [Rueskamp]
  Id_IPMC_rtv_audio = '224.0.1.169'; //rtv-audio                                      [Adams]
  Id_IPMC_rtv_video = '224.0.1.170'; //rtv-video                                      [Adams]
  Id_IPMC_HAVI_Sim = '224.0.1.171'; //HAVI-Sim                                  [Wasserroth]
  Id_IPMC_Nokia = '224.0.1.172'; //Nokia Cluster                               [O'Rourke]
  Id_IPMC_host_request = '224.0.1.173'; //host-request                              [K.Thompson]
  Id_IPMC_host_announce = '224.0.1.174'; //host-announce                             [K.Thompson]
  Id_IPMC_ptk_cluster = '224.0.1.175'; //ptk-cluster                                  [Hodgson]
  Id_IPMC_Proxim = '224.0.1.176'; //Proxim Protocol                               [Shukla]
//  Id_IPMC_Unassigned = '//224.0.1.177-224.0.1.255'; //Unassigned                          [JBP]
  Id_IPMC_rwho = '224.0.2.1'; //"rwho" Group (BSD) (unofficial)                   [JBP]
  Id_IPMC_SUN = '224.0.2.2'; //SUN RPC PMAPPROC_CALLIT                          [BXE1]
{
224.0.2.0 - 224.0.255.0   AD-HOC Block
}

  Id_IPMC_SIAC_Min = '224.0.2.064';
  Id_IPMC_SIAC_Max = '224.0.2.095'; //SIAC MDD Service                     [Tse]
  Id_IPMC_CoolCast_Min = '224.0.2.096';
  Id_IPMC_CoolCast_Max = '224.0.2.127'; //CoolCast                       [Ballister]
  Id_IPMC_WOZ_Garage_Min = '224.0.2.128';
  Id_IPMC_WOZ_Garage_Max = '224.0.2.191'; //WOZ-Garage		       [Marquardt]
  Id_IPMC_SIAC_Market_Min = '224.0.2.192';
  Id_IPMC_SIAC_Market_Max = '224.0.2.255'; //SIAC MDD Market Service          [Lamberg]
  Id_IPMC_RFE_Generic_Min = '224.0.3.000';
  Id_IPMC_RFE_Generic_Max = '224.0.3.255'; //RFE Generic Service                 [DXS3]
  Id_IPMC_RFE_Individual_Min = '224.0.4.000';
  Id_IPMC_RFE_Individual_Max = '224.0.4.255'; //RFE Individual Conferences          [DXS3]
  Id_IPMC_CDPD_Min = '224.0.5.000';
  Id_IPMC_CDPD_Max = '224.0.5.127'; //CDPD Groups                  [Bob Brenner]
  Id_IPMC_SIAC_Market2_Min = '224.0.5.128'; //SIAC Market Service                  [Cho]
  Id_IPMC_SIAC_Market2_Max = '224.0.5.191';
  Id_IPMC_SIAC_MYSE_Min = '224.0.5.192'; //SIAC NYSE Order PDP protocol     [Chan]
  Id_IPMC_SIAC_MYSE_Max = '224.0.5.255';
  Id_IPMC_Cornell_Min = '224.0.6.000'; //Cornell ISIS Project           [Tim Clark]
  Id_IPMC_Cornell_Max = '224.0.6.127';
 // Id_IPMC_Unassigned = '224.0.6.128-224.0.6.255'; //Unassigned			    [IANA]
  Id_IPMC_Where_Are_You_Min = '224.0.7.000'; //Where-Are-You                    [Simpson]
  Id_IPMC_Where_Are_You_Max = '224.0.7.255';
  Id_IPMC_INTV_Min = '224.0.8.000'; //INTV                               [Tynan]
  Id_IPMC_INTV_Max = '224.0.8.255';
  Id_IPMC_Invisible_Min = '224.0.9.000'; //Invisible Worlds                 [Malamud]
  Id_IPMC_Invisible_Max = '224.0.9.255';
  Id_IPMC_DLSw_Min = '224.0.10.000'; //DLSw Groups                        [Lee]
  Id_IPMC_DLSw_Max = '224.0.10.255';
  Id_IPMC_NCC_NET_Min = '224.0.11.000'; //NCC.NET Audio                    [Rubin]
  Id_IPMC_NCC_NET_Max = '224.0.11.255';
  Id_IPMC_Microsoft_Min = '224.0.12.000'; //Microsoft and MSNBC              [Blank]
  Id_IPMC_Microsoft_Max = '224.0.12.063';
  Id_IPMC_UUNET_Min = '224.0.13.000'; //UUNET PIPEX  Net News           [Barber]
  Id_IPMC_UUNET_Max = '224.0.13.255';
  Id_IPMC_NLANR_Min = '224.0.14.000'; //NLANR				 [Wessels]
  Id_IPMC_NLANR_Max = '224.0.14.255';
  Id_IPMC_Hewlett_Min = '224.0.15.000'; //Hewlett Packard         [van der Meulen]
  Id_IPMC_Hewlett_Max = '224.0.15.255';
  Id_IPMC_XingNet_Min = '224.0.16.000'; //XingNet		        [Uusitalo]
  Id_IPMC_XingNet_Max = '224.0.16.255';
  Id_IPMC_Mercantile_Min = '224.0.17.000'; //Mercantile & Commodity Exchange [Gilani]
  Id_IPMC_Mercantile_Max = '224.0.17.031';
  Id_IPMC_NDQMD1_Min = '224.0.17.032'; //NDQMD1			  [Nelson]
  Id_IPMC_NDQMD1_Max = '224.0.17.063';
  Id_IPMC_ODN_DTV_Min = '224.0.17.064'; //ODN-DTV			  [Hodges]
  Id_IPMC_ODN_DTV_Max = '224.0.17.127';
  Id_IPMC_Dow_Min = '224.0.18.000'; //Dow Jones                         [Peng]
  Id_IPMC_Dow_Max = '224.0.18.255';
  Id_IPMC_Walt_Min = '224.0.19.000'; //Walt Disney Company             [Watson]
  Id_IPMC_Walt_Max = '224.0.19.063';
  Id_IPMC_Cal_Min = '224.0.19.064'; //Cal Multicast                    [Moran]
  Id_IPMC_Cal_Max = '224.0.19.095';
  Id_IPMC_SIAC_Market3_Min = '224.0.19.096'; //SIAC Market Service                [Roy]
  Id_IPMC_SIAC_Market3_Max = '224.0.19.127';
  Id_IPMC_IIG_Min = '224.0.19.128'; //IIG Multicast                     [Carr]
  Id_IPMC_IIG_Max = '224.0.19.191';
  Id_IPMC_Metropol_Min = '224.0.19.192'; //Metropol                      [Crawford]
  Id_IPMC_Metropol_Max = '224.0.19.207';
  Id_IPMC_Xenoscience_Min = '224.0.19.208'; //Xenoscience, Inc.                 [Timm]
  Id_IPMC_Xenoscience_Max = '224.0.19.239';
  Id_IPMC_HYPERFEED_Min = '224.0.19.240'; //HYPERFEED			   [Felix]
  Id_IPMC_HYPERFEED_Max = '224.0.19.255';
  Id_IPMC_MS_IP_TV_Min = '224.0.20.000'; //MS-IP/TV                          [Wong]
  Id_IPMC_MS_IP_TV_Max = '224.0.20.063';
  Id_IPMC_Reliable_Min = '224.0.20.064'; //Reliable Network Solutions      [Vogels]
  Id_IPMC_Reliable_Max = '224.0.20.127';
  Id_IPMC_TRACKTICKER_Min = '224.0.20.128'; //TRACKTICKER Group               [Novick]
  Id_IPMC_TRACKTICKER_Max = '224.0.20.143';
  Id_IPMC_CNR_Min = '224.0.20.144'; //CNR Rebroadcast MCA		 [Sautter]
  Id_IPMC_CNR_Max = '224.0.20.207';
  Id_IPMC_Talarian_Min = '224.0.21.000'; //Talarian MCAST                  [Mendal]
  Id_IPMC_Talarian_Max = '224.0.21.127';
  Id_IPMC_WORLD_Min = '224.0.22.000'; //WORLD MCAST			 [Stewart]
  Id_IPMC_WORLD_Max = '224.0.22.255';
  Id_IPMC_Domain_Min = '224.0.252.000'; //Domain Scoped Group	          [Fenner]
  Id_IPMC_Domain_Max = '224.0.252.000-224.0.252.255';
  Id_IPMC_Report_Min = '224.0.253.000'; //Report Group                  [Fenner]
  Id_IPMC_Report_Max = '224.0.253.255';
  Id_IPMC_Query_Min = '224.0.254.000'; //Query Group                   [Fenner]
  Id_IPMC_Query_Max = '224.0.254.255';
  Id_IPMC_Border_Min = '224.0.255.000'; //Border Routers                [Fenner]
  Id_IPMC_Border_Max = '224.0.255.255';
{
  224.1.0.0 - 224.1.255.255 (224.1/16) ST Multicast Groups [RFC1190,KS14]
}


  Id_IPMC_Multimedia_Min = '224.2.0.0'; //Multimedia Conference Calls       [SC3]
  Id_IPMC_Multimedia_Max = '224.2.127.253'; //Multimedia Conference Calls       [SC3]
  Id_IPMC_SAPv1 = '224.2.127.254'; //SAPv1 Announcements               [SC3]
  Id_IPMC_SAPv0 = '224.2.127.255'; //SAPv0 Announcements (deprecated)  [SC3]
  Id_IPMC_SAP_Min = '224.2.128.0'; //SAP Dynamic Assignments           [SC3]
  Id_IPMC_SAP_Max = '224.2.255.255'; //SAP Dynamic Assignments           [SC3]

//  Id_IPMC_Reserved_Min = '224.3.0.0'; //Reserved                        [IANA]
//  Id_IPMC_Reserved_Max = '224.251.255.255'; //Reserved                        [IANA]
  Id_IPMC_DIS_Min = '224.252.000.000'; //DIS Transient Groups        [IANA]
  Id_IPMC_DIS_Max = '224.255.255.255'; //DIS Transient Groups        [IANA]
 // Id_IPMC_Reserved_Min = '225.000.000.000'; //Reserved	 	    [IANA]
 // Id_IPMC_Reserved_Max = '231.255.255.255'; //Reserved	 	    [IANA]
  Id_IPMC_Source_Min = '232.000.000.000'; //Source Specific Multicast   [DRC3]
  Id_IPMC_Source_Max = '232.255.255.255'; //Source Specific Multicast   [DRC3]
  Id_IPMC_GLOP_Min = '233.000.000.000'; //GLOP Block                  [RFC3180]
  Id_IPMC_GLOP_Max = '233.255.255.255'; //GLOP Block                  [RFC3180]
//  Id_IPMC_Reserved_Min = '234.000.000.000'; //Reserved                    [IANA]
//  Id_IPMC_Reserved_Max = '238.255.255.255'; //Reserved                    [IANA]
  Id_IPMC_Administratively_Min = '239.000.000.000'; //Administratively Scoped    [IANA,RFC2365]
  Id_IPMC_Administratively_Max = '239.255.255.255'; //Administratively Scoped    [IANA,RFC2365]
//  Id_IPMC_Reserved_Min = '239.000.000.000'; //Reserved                    [IANA]
//  Id_IPMC_Reserved_Max = '239.063.255.255'; //Reserved                    [IANA]
//  Id_IPMC_Reserved_Min = '239.064.000.000'; //Reserved                    [IANA]
//  Id_IPMC_Reserved_Max = '239.127.255.255'; //Reserved                    [IANA]
//  Id_IPMC_Reserved_Min = '239.128.000.000'; //Reserved                    [IANA]
 // Id_IPMC_Reserved_Max = '239.191.255.255'; //Reserved                    [IANA]
  Id_IPMC_Organization_Local_Min = '239.192.000.000'; //Organization-Local Scope   [Meyer,RFC2365]
  Id_IPMC_Organization_Local_Max = '239.251.255.255'; //Organization-Local Scope   [Meyer,RFC2365]
  Id_IPMC_Site_Local1_Min = '239.252.000.000'; //Site-Local Scope (reserved)[Meyer,RFC2365]
  Id_IPMC_Site_Local1_Max = '239.252.255.255'; //Site-Local Scope (reserved)[Meyer,RFC2365]
  Id_IPMC_Site_Local2_Min = '239.253.000.000'; //Site-Local Scope (reserved)[Meyer,RFC2365]
  Id_IPMC_Site_Local2_Max = '239.253.255.255'; //Site-Local Scope (reserved)[Meyer,RFC2365]
  Id_IPMC_Site_Local3_Min = '239.254.000.000'; //Site-Local Scope (reserved)[Meyer,RFC2365]
  Id_IPMC_Site_Local3_Max = '239.254.255.255'; //Site-Local Scope (reserved)[Meyer,RFC2365]
  Id_IPMC_Site_Local4_Min = '239.255.000.000'; //Site-Local Scope           [Meyer,RFC2365]
  Id_IPMC_Site_Local4_Max = '239.255.255.255'; //Site-Local Scope           [Meyer,RFC2365]
